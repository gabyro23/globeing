  ...
  const items = useMemo(() => {
    return countries
      .map((country) => {
        ...
        // Drop far-off overseas exclaves before projecting (mainland
        // France + French Guiana is the textbook case) — left in, they
        // blow out the bounding box and shrink the shape actually drawn
        // well below the true-scale size this box was sized for. See
        // lib/mainLandmass.js.
        ...
        const projection = d3
          ...
          .fitSize([targetPx, targetPx], mainFeature);
